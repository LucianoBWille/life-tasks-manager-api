...
-- AddForeignKey
ALTER TABLE "tasks_responsibles" ADD CONSTRAINT "tasks_responsibles_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
